...
def getCommandLineArguments(cammand_line_arguments):
    ...
    params['round'] = [1]
    params['dimension'] = [1000]#range(1000,11000,1000)#[1000]
    params['ell'] = range(10,220,10)
    params['signal_dimension'] = [20]
...
if __name__ == '__main__':    
    ...
    for params_values in listOuterProduct(params_lists):
        ...
        try:
            ...
            sketchers = [sketch_class(dimension,ell,ell) for sketch_class in scketcherClasses]
            ...
            ATA = numpy.zeros((dimension,dimension))
